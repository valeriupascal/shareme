...
const Pin = ({ pin: { postedBy, image, _id, destination, save }}) => {
  ...
  const savePin = (id) => {
    if(!alreadySaved) {
      ...
      // update the doc in sanity database
      client
        .patch(id)
        .setIfMissing({ save: [] })
        .insert('after', 'save[-1]', [{
  ...
  return (
    <div className='m-2'>
      ...
      >
        ...
        {postHovered && (
          ...
          >
            <div className='flex items-center justify-between'>
              ...
              {/* here is href to image  and postedBy */}
            <div className='flex justify-between items-center gap-2 w-full'>
              {destination && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='flex bg-white items-center gap-2 text-black font-bolf p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md'
                >
              ...
              {/* if user is postedBy then Detele button */}
        ...
        {/* here we will have link to profile user  */}
